...
class TrackingStateManager: ObservableObject {
    ...
    private let stateQueue = DispatchQueue(label: "com.beenthere.trackingstate")
    ...
    func startTracking(source: TrackingSource, interval: TimeInterval? = nil, accuracy: Double? = nil) -> Bool {
        ...
        // Reset place detection tracking state
        PlaceDetectionManager.shared.resetTrackingState()

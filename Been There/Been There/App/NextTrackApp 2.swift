...
struct NextTrackApp: App {
    ...
    private func handleScenePhaseChange(_ phase: ScenePhase) {
        ...
        case .background:
            ...
            print("[BeenThereApp] App entering background - saving session")
        ...
        case .active:
            ...
            print("[BeenThereApp] App became active")
    ...
    private func checkAndApplyLock() {
        ...
        if let backgroundTime = lockBackgroundTime {
            ...
            if elapsed > delaySeconds {
                ...
                print("[BeenThereApp] App locked after \(Int(elapsed))s in background")
            }
        }
    }
    ...
    private func checkForAppRestart() {
        ...
        if appHasLaunchedBefore && lastBackgroundTimestamp > 0 {
            ...
            if elapsed > 30 {
                ...
                print("[BeenThereApp] App restarted after \(Int(elapsed)) seconds")

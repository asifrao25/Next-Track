...
# Next-track Xcode Project Setup Script
# This script generates the Xcode project using XcodeGen

echo "🚀 Next-track Project Setup"
echo "=========================="
...
ASSETS_DIR="Next-track/Resources/Assets.xcassets"
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "📱 Next steps:"
    echo "   1. Open Next-track.xcodeproj in Xcode"
